...
```{r plot-ind, fig.width=5, fig.height=3.5, fig.show='hold', fig.align='center'}
...
```{r plot-var, fig.width=5, fig.height=3.5, fig.show='hold', fig.align='center'}
...
```{r plot-valid, fig.width=7, fig.height=5, fig.align='center'}
## Partial bootstrap
Y <- bootstrap(X, n = 30)
