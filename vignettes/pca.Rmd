...
viz_variables(
  x = X, 
  map_color = "cos2", 
  scale_color = khroma::color("YlOrBr")(12)
)
```
...
viz_individuals(
  ...
  scale_color = khroma::color("bright")(3), # Custom color scale
  scale_shape = c(15, 16, 17) # Custom symbols
)
```
...
viz_individuals(
  ...
  scale_color = khroma::color("YlOrBr")(12), # Custom color scale
  scale_shape = 16
)
```
...
viz_individuals(
  ...
  map_color = "contrib", 
  map_size = "contrib",
  scale_color = khroma::color("iridescent")(12), # Custom color scale
  scale_shape = 16
)
```
